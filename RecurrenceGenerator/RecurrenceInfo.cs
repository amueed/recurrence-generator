...
namespace RecurrenceGenerator
{
    ...
    {
        private EndDateType endDateType = EndDateType.NotDefined;
        ...
        private RecurrenceType recurrenceType = RecurrenceType.NotSet;

        #region Internal Daily-Specific

        private DailyRegenType dailyRegenType;
        private int dailyRegenEveryXDays;
        ...
        private SelectedDayOfWeekValues selectedDayOfWeekValues;
        private WeeklyRegenType weeklyRegenType;
        ...
        private MonthlyRegenType monthlyRegenType;
        private MonthlySpecificDatePartOne monthlySpecificDatePartOne;
        private MonthlySpecificDatePartTwo monthlySpecificDatePartTwo;
        private int monthlyRegenerateOnSpecificDateDayValue;
        private int regenEveryXMonths;
        ...
        #endregion Public Yearly-Specific Fields

        #region Internal Yearly-Specific

        private int specificDateDayValue;
        private int specificDateMonthValue;
        private YearlyRegenType yearlyRegenType = YearlyRegenType.NotSet;
        private YearlySpecificDatePartOne yearlySpecificDatePartOne = YearlySpecificDatePartOne.NotSet;
        private YearlySpecificDatePartTwo yearlySpecificDatePartTwo = YearlySpecificDatePartTwo.NotSet;
        private YearlySpecificDatePartThree yearlySpecificDatePartThree = YearlySpecificDatePartThree.NotSet;
        ...
        #endregion Internal Global Setters
