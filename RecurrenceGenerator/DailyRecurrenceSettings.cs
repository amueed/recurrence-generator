...
namespace RecurrenceGenerator
{
    ...
    public class DailyRecurrenceSettings : RecurrenceSettings
    {
        ...
        private DailyRegenType regenType = DailyRegenType.OnEveryWeekday;
        private int regenEveryXDays = 1;
        private bool getNextDateValue;
        private DateTime nextDateValue;
        private DateTime finalNextDateValue;
        ...
        private void SetValues(int regenEveryXDays)
        {
            this.regenEveryXDays = regenEveryXDays;
            regenType = DailyRegenType.OnEveryXDays;
        }
        ...
        private static DailyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedStartDate, DateTime modifiedEndDate)
        {
        ...
        private static DailyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedEndDate)
        {
            RecurrenceInfo info = DailyRecurrenceSettings.GetFriendlyRecurrenceInfo(seriesInfo);
        ...
        /// </summary>
        /// <returns>RecurrenceValues</returns>
        private RecurrenceValues GetEveryWeekday()
        {
        ...
        private DateTime GetNextWeekday(DateTime input)
        {
            do
            {
        ...
        /// </summary>
        /// <returns></returns>
        private RecurrenceValues GetEveryXDaysValues()
        {
            RecurrenceValues values;
            DateTime dt = base.StartDate;
