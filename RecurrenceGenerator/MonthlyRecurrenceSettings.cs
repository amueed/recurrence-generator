...
namespace RecurrenceGenerator
{
    ...
    public class MonthlyRecurrenceSettings : RecurrenceSettings
    {
        ...
        /// </summary>
        /// <returns></returns>
        private RecurrenceValues GetSpecificDayOfMonthDates()
        {
        ...
        /// </summary>
        /// <returns></returns>
        private RecurrenceValues GetCustomDayOfMonthDates()
        {
        ...
        /// <returns></returns>
        private DateTime GetCustomDate(DateTime currentDate)
        {
        ...
        private void SetValues(MonthlySpecificDatePartOne customDatePartOne, MonthlySpecificDatePartTwo customDatePartTwo, int regenEveryXMonths)
        {
            this.regenEveryXMonths = regenEveryXMonths;
            specificDatePartOne = customDatePartOne;
            specificDatePartTwo = customDatePartTwo;
        ...
        private void SetValues(int dayOfMonthToRegen, int regenEveryXMonths)
        {
            this.regenEveryXMonths = regenEveryXMonths;
            regenerateOnSpecificDateDayValue = dayOfMonthToRegen;
            regenType = MonthlyRegenType.OnSpecificDayOfMonth;
        ...
        private static MonthlyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedStartDate, DateTime modifiedEndDate)
        {
        ...
        private static MonthlyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedEndDate)
        {
            // Get the Recurrence Info object. This makes it easy to work with existing series of date patterns.
            RecurrenceInfo info = MonthlyRecurrenceSettings.GetFriendlyRecurrenceInfo(seriesInfo);
