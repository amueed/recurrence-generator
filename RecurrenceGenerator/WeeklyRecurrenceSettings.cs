...
namespace RecurrenceGenerator
{
    ...
    public class WeeklyRecurrenceSettings : RecurrenceSettings
    {
        ...
        private void SetValues(int regenEveryXWeeks, SelectedDayOfWeekValues selectedDays)
        {
            this.regenEveryXWeeks = regenEveryXWeeks;
            regenType = WeeklyRegenType.OnEveryXWeeks;
            this.selectedDays = selectedDays;
        ...
        private static WeeklyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedStartDate, DateTime modifiedEndDate)
        {
        ...
        private static WeeklyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedEndDate)
        {
            RecurrenceInfo info = WeeklyRecurrenceSettings.GetFriendlyRecurrenceInfo(seriesInfo);
