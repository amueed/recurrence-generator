...
namespace RecurrenceGenerator
{
    ...
    public class YearlyRecurrenceSettings : RecurrenceSettings
    {
        ...
        private void SetValues(int specificDateDayValue, int specificDateMonthValue)
        {
            regenerateOnSpecificDateDayValue = specificDateDayValue;
            regenerateOnSpecificDateMonthValue = specificDateMonthValue;
            regenType = YearlyRegenType.OnSpecificDayOfYear;
        ...
        private void SetValues(YearlySpecificDatePartOne customDateFirstPart, YearlySpecificDatePartTwo customDateSecondPart, YearlySpecificDatePartThree customDateThirdPart)
        {
            specificDatePartOne = customDateFirstPart;
            specificDatePartTwo = customDateSecondPart;
            specificDatePartThree = customDateThirdPart;
        ...
        private static YearlyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedStartDate, DateTime modifiedEndDate)
        {
        ...
        private static YearlyRecurrenceSettings GetRecurrenceSettings(string seriesInfo, int modifiedOccurrencesValue, DateTime modifiedEndDate)
        {
            // Get the Recurrence Info object. This makes it easy to work with existing series of date patterns.
            RecurrenceInfo info = YearlyRecurrenceSettings.GetFriendlyRecurrenceInfo(seriesInfo);
        ...
        /// </summary>
        /// <returns></returns>
        private RecurrenceValues GetSpecificDayOfYearDates()
        {
        ...
        private DateTime GetCorrectedDate(DateTime input)
        {
            DateTime dt = input;
        ...
        /// </summary>
        /// <returns></returns>
        private RecurrenceValues GetCustomDayOfYearDates()
        {
        ...
        /// <returns></returns>
        private DateTime GetCustomDate(int year)
        {
        ...
        private DateTime GetCustomWeekday(DateTime startDate, DayOfWeek weekDay, int daysOfMonth, int firstDatePart)
        {
            int day = 1;
            int dayCount = 0;
        ...
        private int GetDatePartOneValue()
        {
            int val = 0;
